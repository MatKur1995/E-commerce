...
export const EditProduct = () => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        axios.put(`http://localhost:5000/products/edit-product/${id}`, data, {
            headers: {
        ...
        <>
            ...
            <div className="add-prodduct-container">
                <form className="add-product-form" onSubmit={handleSubmit}>
                    <p className="add-product-title">Edit product</p>
                    ...
                    <button type="submit" className="submit-button"><i className="fa-solid fa-plus"></i> Edit Product
                    </button>
                </form>
            </div>
        </>
